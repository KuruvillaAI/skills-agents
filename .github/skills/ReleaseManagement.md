...
## Purpose
Tagging and publishing versioned releases.

## Description
This skill packages the domain knowledge and conventions required to tagging and publishing versioned releases. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the ReleaseManagement skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Scanning and remediating dependency vulnerabilities.

## Description
This skill packages the domain knowledge and conventions required to scanning and remediating dependency vulnerabilities. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Related Hooks
DependencySecurityHook

## Example
"Apply the DependencySecurity skill to implement/update <specific artifact> following this project's conventions."

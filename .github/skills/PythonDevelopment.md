...
## Purpose
Idiomatic, typed, well-structured Python practices.

## Description
This skill packages the domain knowledge and conventions required to idiomatic, typed, well-structured Python practices. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the PythonDevelopment skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Writing isolated unit tests with mocked dependencies.

## Description
This skill packages the domain knowledge and conventions required to writing isolated unit tests with mocked dependencies. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the UnitTesting skill to implement/update <specific artifact> following this project's conventions."

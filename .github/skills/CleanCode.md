...
## Purpose
Readability, naming, and simplicity standards.

## Description
This skill packages the domain knowledge and conventions required to readability, naming, and simplicity standards. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the CleanCode skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Safely improving code structure without changing behavior.

## Description
This skill packages the domain knowledge and conventions required to safely improving code structure without changing behavior. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the Refactoring skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Securing API endpoints: validation, rate limiting, CORS, auth.

## Description
This skill packages the domain knowledge and conventions required to securing API endpoints: validation, rate limiting, CORS, auth. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the APISecurity skill to implement/update <specific artifact> following this project's conventions."

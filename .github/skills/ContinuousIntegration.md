...
## Purpose
CI pipeline design: lint, test, security scan, build.

## Description
This skill packages the domain knowledge and conventions required to cI pipeline design: lint, test, security scan, build. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the ContinuousIntegration skill to implement/update <specific artifact> following this project's conventions."

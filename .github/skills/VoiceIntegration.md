...
## Purpose
Optional speech-to-text/text-to-speech integration.

## Description
This skill packages the domain knowledge and conventions required to optional speech-to-text/text-to-speech integration. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the VoiceIntegration skill to implement/update <specific artifact> following this project's conventions."

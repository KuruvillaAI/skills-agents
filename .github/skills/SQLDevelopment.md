...
## Purpose
Writing and reviewing SQL and migrations.

## Description
This skill packages the domain knowledge and conventions required to writing and reviewing SQL and migrations. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Related Agents
SQLAgent, MigrationAgent

## Related Hooks
DatabaseMigrationHook

## Example
"Apply the SQLDevelopment skill to implement/update <specific artifact> following this project's conventions."

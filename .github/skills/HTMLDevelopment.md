...
## Purpose
Semantic HTML, accessibility, forms, and SEO practices.

## Description
This skill packages the domain knowledge and conventions required to semantic HTML, accessibility, forms, and SEO practices. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the HTMLDevelopment skill to implement/update <specific artifact> following this project's conventions."

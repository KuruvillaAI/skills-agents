...
## Purpose
Implements the chat interface and its interaction states.

## Description
This skill packages the domain knowledge and conventions required to implements the chat interface and its interaction states. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the ChatUI skill to implement/update <specific artifact> following this project's conventions."

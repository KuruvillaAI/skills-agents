...
## Purpose
Data access behind repository interfaces.

## Description
This skill packages the domain knowledge and conventions required to data access behind repository interfaces. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the RepositoryDevelopment skill to implement/update <specific artifact> following this project's conventions."

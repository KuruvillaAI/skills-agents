...
## Purpose
Testing across module/service boundaries.

## Description
This skill packages the domain knowledge and conventions required to testing across module/service boundaries. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the IntegrationTesting skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
GitHub issues, PRs, and repository operations.

## Description
This skill packages the domain knowledge and conventions required to gitHub issues, PRs, and repository operations. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the GitHubManagement skill to implement/update <specific artifact> following this project's conventions."

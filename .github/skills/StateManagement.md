...
## Purpose
Manages application state via Context API or Redux Toolkit.

## Description
This skill packages the domain knowledge and conventions required to manages application state via Context API or Redux Toolkit. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the StateManagement skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Producing and maintaining living documentation.

## Description
This skill packages the domain knowledge and conventions required to producing and maintaining living documentation. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the DocumentationWriting skill to implement/update <specific artifact> following this project's conventions."

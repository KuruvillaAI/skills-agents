...
## Purpose
Detecting and documenting undocumented functionality.

## Description
This skill packages the domain knowledge and conventions required to detecting and documenting undocumented functionality. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the FeatureDiscovery skill to implement/update <specific artifact> following this project's conventions."

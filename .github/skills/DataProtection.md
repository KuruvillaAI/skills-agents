...
## Description
This skill packages the domain knowledge and conventions required to protecting sensitive data at rest and in transit. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the DataProtection skill to implement/update <specific artifact> following this project's conventions."

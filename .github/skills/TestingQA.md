...
## Purpose
Overall test strategy and coverage standards.

## Description
This skill packages the domain knowledge and conventions required to overall test strategy and coverage standards. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Related Agents
TestArchitectureAgent, QAAgent

## Related Hooks
CoverageHook

## Example
"Apply the TestingQA skill to implement/update <specific artifact> following this project's conventions."

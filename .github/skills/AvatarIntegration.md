...
## Purpose
Optional avatar/visual presence integration.

## Description
This skill packages the domain knowledge and conventions required to optional avatar/visual presence integration. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the AvatarIntegration skill to implement/update <specific artifact> following this project's conventions."

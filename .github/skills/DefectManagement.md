...
## Purpose
Recording, tracking, and retesting defects.

## Description
This skill packages the domain knowledge and conventions required to recording, tracking, and retesting defects. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the DefectManagement skill to implement/update <specific artifact> following this project's conventions."

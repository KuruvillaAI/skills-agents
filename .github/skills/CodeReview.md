...
## Purpose
Automated and Copilot-assisted review of proposed changes.

## Description
This skill packages the domain knowledge and conventions required to automated and Copilot-assisted review of proposed changes. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the CodeReview skill to implement/update <specific artifact> following this project's conventions."

...
## Purpose
Schema design and connection management.

## Description
This skill packages the domain knowledge and conventions required to schema design and connection management. It is invoked by its related agents whenever a task falls within this scope, and should be referenced by GitHub Copilot Chat when working on related files.
...
## Example
"Apply the DatabaseDevelopment skill to implement/update <specific artifact> following this project's conventions."

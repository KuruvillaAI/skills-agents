...
## Purpose
Scan for hardcoded secrets, keys, and credentials.
...
2. Invoke the responsible agent(s): SecretsSecurityAgent.
3. Apply the relevant skill(s): SecretsManagement.
...
## Example
"Trigger SecretsScanHook after before commit / in CI and report the result."

...
## Trigger
A chat query is received or a prompt template changes

## Purpose
Test/verify prompt injection resistance for the grounding pipeline.
...
2. Invoke the responsible agent(s): PromptInjectionAgent.
3. Apply the relevant skill(s): PromptInjectionProtection.
...
## Example
"Trigger PromptInjectionHook after a chat query is received or a prompt template changes and report the result."

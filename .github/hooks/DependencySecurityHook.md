...
## Trigger
Dependency manifests change / on schedule
...
2. Invoke the responsible agent(s): DependencySecurityAgent.
3. Apply the relevant skill(s): DependencySecurity.
...
## Example
"Trigger DependencySecurityHook after dependency manifests change / on schedule and report the result."

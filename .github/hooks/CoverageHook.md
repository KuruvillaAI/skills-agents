...
## Purpose
Update and report test coverage across repositories.
...
2. Invoke the responsible agent(s): CoverageAgent.
3. Apply the relevant skill(s): TestCoverage.
...
## Example
"Trigger CoverageHook after after test runs and report the result."

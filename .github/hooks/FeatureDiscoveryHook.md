...
## Trigger
New functionality is detected during QA

## Purpose
Update the feature catalog, UI catalog, workflows, test cases, and regression matrix.
...
3. Apply the relevant skill(s): FeatureDiscovery.
...
## Example
"Trigger FeatureDiscoveryHook after new functionality is detected during QA and report the result."

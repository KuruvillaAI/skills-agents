...
## Trigger
Backend source changes / before commit

## Purpose
Run backend build/import checks to catch structural errors early.
...
2. Invoke the responsible agent(s): BackendArchitectureAgent.
...
## Example
"Trigger BackendBuildHook after backend source changes / before commit and report the result."

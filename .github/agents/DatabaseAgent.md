...
## Purpose
Owns database schema design and connection management.
...
- "Using DatabaseAgent, implement <specific task in its domain>."
- "Ask DatabaseAgent to review <artifact> for compliance with its architecture and security rules."

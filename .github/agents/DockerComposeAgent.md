...
## Purpose
Authors and maintains docker-compose configuration for local full-stack startup.
...
- "Using DockerComposeAgent, implement <specific task in its domain>."
- "Ask DockerComposeAgent to review <artifact> for compliance with its architecture and security rules."

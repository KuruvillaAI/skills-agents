...
## Purpose
Secures LLM integration points against abuse and data leakage.
...
- "Using LLMSecurityAgent, implement <specific task in its domain>."
- "Ask LLMSecurityAgent to review <artifact> for compliance with its architecture and security rules."

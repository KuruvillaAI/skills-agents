...
## Purpose
Wires interfaces to implementations via constructor/provider-based dependency injection.
...
- "Using DependencyInjectionAgent, implement <specific task in its domain>."
- "Ask DependencyInjectionAgent to review <artifact> for compliance with its architecture and security rules."

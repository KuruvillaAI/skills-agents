...
## Purpose
Implements tracing, metrics, and dashboards.
...
- "Using ObservabilityAgent, implement <specific task in its domain>."
- "Ask ObservabilityAgent to review <artifact> for compliance with its architecture and security rules."

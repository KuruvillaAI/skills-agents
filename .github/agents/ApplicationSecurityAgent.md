...
## Purpose
Reviews application code for OWASP Top 10 vulnerabilities.
...
- "Using ApplicationSecurityAgent, implement <specific task in its domain>."
- "Ask ApplicationSecurityAgent to review <artifact> for compliance with its architecture and security rules."

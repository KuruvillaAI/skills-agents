...
## Purpose
Implements structured, safe backend logging that never leaks secrets or document contents.
...
- "Using BackendLoggingAgent, implement <specific task in its domain>."
- "Ask BackendLoggingAgent to review <artifact> for compliance with its architecture and security rules."

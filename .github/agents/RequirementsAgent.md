...
## Purpose
Captures and clarifies functional and non-functional requirements.
...
- "Using RequirementsAgent, implement <specific task in its domain>."
- "Ask RequirementsAgent to review <artifact> for compliance with its architecture and security rules."

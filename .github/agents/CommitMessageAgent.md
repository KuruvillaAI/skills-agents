...
- "Using CommitMessageAgent, implement <specific task in its domain>."
- "Ask CommitMessageAgent to review <artifact> for compliance with its architecture and security rules."

...
- "Using TaskPlanningAgent, implement <specific task in its domain>."
- "Ask TaskPlanningAgent to review <artifact> for compliance with its architecture and security rules."

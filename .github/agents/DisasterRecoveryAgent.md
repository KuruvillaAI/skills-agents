...
## Purpose
Defines recovery procedures for critical system failures.
...
- "Using DisasterRecoveryAgent, implement <specific task in its domain>."
- "Ask DisasterRecoveryAgent to review <artifact> for compliance with its architecture and security rules."

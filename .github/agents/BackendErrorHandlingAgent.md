...
## Purpose
Designs consistent structured error handling and exception-to-HTTP mapping.
...
- "Using BackendErrorHandlingAgent, implement <specific task in its domain>."
- "Ask BackendErrorHandlingAgent to review <artifact> for compliance with its architecture and security rules."

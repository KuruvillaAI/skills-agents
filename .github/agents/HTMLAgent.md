...
## Purpose
Specializes in semantic HTML, accessibility, forms, browser compatibility, and SEO.
...
- "Using HTMLAgent, implement <specific task in its domain>."
- "Ask HTMLAgent to review <artifact> for compliance with its architecture and security rules."

# EnvironmentConfigurationAgent

## Purpose
Manages per-environment configuration values.
...
- "Using EnvironmentConfigurationAgent, implement <specific task in its domain>."
- "Ask EnvironmentConfigurationAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Provides Next.js-specific guidance if that stack variant is ever selected; not used by default (project uses React + Vite + TypeScript).
...
- "Using NextJSAgent, implement <specific task in its domain>."
- "Ask NextJSAgent to review <artifact> for compliance with its architecture and security rules."

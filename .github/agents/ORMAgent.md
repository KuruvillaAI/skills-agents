...
## Purpose
Manages ORM models, sessions, and query patterns.
...
- "Using ORMAgent, implement <specific task in its domain>."
- "Ask ORMAgent to review <artifact> for compliance with its architecture and security rules."

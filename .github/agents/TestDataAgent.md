...
## Purpose
Manages fixtures and synthetic test data.
...
- "Using TestDataAgent, implement <specific task in its domain>."
- "Ask TestDataAgent to review <artifact> for compliance with its architecture and security rules."

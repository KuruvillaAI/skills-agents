...
## Purpose
Designs and maintains system/user prompt templates used across the generation pipeline.
...
- "Using PromptEngineeringAgent, implement <specific task in its domain>."
- "Ask PromptEngineeringAgent to review <artifact> for compliance with its architecture and security rules."

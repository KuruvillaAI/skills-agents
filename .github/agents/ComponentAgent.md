...
## Purpose
Builds reusable, tested, accessible UI components.
...
- "Using ComponentAgent, implement <specific task in its domain>."
- "Ask ComponentAgent to review <artifact> for compliance with its architecture and security rules."

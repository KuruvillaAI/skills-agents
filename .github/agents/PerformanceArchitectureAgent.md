# PerformanceArchitectureAgent

## Purpose
Defines performance budgets and cross-cutting performance strategy.
...
- "Using PerformanceArchitectureAgent, implement <specific task in its domain>."
- "Ask PerformanceArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

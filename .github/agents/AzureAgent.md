...
## Purpose
Provides Azure-specific deployment guidance.
...
- "Using AzureAgent, implement <specific task in its domain>."
- "Ask AzureAgent to review <artifact> for compliance with its architecture and security rules."

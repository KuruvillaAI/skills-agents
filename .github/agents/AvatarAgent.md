...
## Purpose
Implements optional avatar/visual presence features without ever bypassing grounding or security.
...
- "Using AvatarAgent, implement <specific task in its domain>."
- "Ask AvatarAgent to review <artifact> for compliance with its architecture and security rules."

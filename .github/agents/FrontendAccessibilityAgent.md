...
## Purpose
Ensures WCAG-compliant accessible UI.
...
- "Using FrontendAccessibilityAgent, implement <specific task in its domain>."
- "Ask FrontendAccessibilityAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Reviews code for SOLID principle compliance.
...
- "Using SOLIDAgent, implement <specific task in its domain>."
- "Ask SOLIDAgent to review <artifact> for compliance with its architecture and security rules."

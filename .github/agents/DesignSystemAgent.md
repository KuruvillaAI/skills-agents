...
- "Using DesignSystemAgent, implement <specific task in its domain>."
- "Ask DesignSystemAgent to review <artifact> for compliance with its architecture and security rules."

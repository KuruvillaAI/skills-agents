...
## Purpose
Maintains frontend README and component documentation.
...
- "Using FrontendDocumentationAgent, implement <specific task in its domain>."
- "Ask FrontendDocumentationAgent to review <artifact> for compliance with its architecture and security rules."

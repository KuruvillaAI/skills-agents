...
## Purpose
Authors and maintains Dockerfiles for backend and frontend.
...
- "Using DockerAgent, implement <specific task in its domain>."
- "Ask DockerAgent to review <artifact> for compliance with its architecture and security rules."

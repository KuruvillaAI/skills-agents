# SecretsManagementAgent

## Purpose
Manages secrets via environment variables and secret stores, never hardcoded.
...
- "Using SecretsManagementAgent, implement <specific task in its domain>."
- "Ask SecretsManagementAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Implements purposeful, performant UI animations and transitions.
...
- "Using AnimationAgent, implement <specific task in its domain>."
- "Ask AnimationAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Implements data access behind repository interfaces, isolating persistence details.
...
- "Using RepositoryAgent, implement <specific task in its domain>."
- "Ask RepositoryAgent to review <artifact> for compliance with its architecture and security rules."

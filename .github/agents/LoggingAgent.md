...
## Purpose
Implements centralized, structured logging.
...
- "Using LoggingAgent, implement <specific task in its domain>."
- "Ask LoggingAgent to review <artifact> for compliance with its architecture and security rules."

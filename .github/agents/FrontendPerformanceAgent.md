...
## Purpose
Optimizes bundle size, rendering performance, and load times.
...
- "Using FrontendPerformanceAgent, implement <specific task in its domain>."
- "Ask FrontendPerformanceAgent to review <artifact> for compliance with its architecture and security rules."

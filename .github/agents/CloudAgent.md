...
## Purpose
Provides provider-agnostic cloud deployment guidance.
...
- "Using CloudAgent, implement <specific task in its domain>."
- "Ask CloudAgent to review <artifact> for compliance with its architecture and security rules."

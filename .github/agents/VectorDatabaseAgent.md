...
## Purpose
Provides a swappable abstraction over vector stores (FAISS, Pinecone) for index, insert, update, delete, and similarity search operations.
...
- "Using VectorDatabaseAgent, implement <specific task in its domain>."
- "Ask VectorDatabaseAgent to review <artifact> for compliance with its architecture and security rules."

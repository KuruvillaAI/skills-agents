...
## Purpose
Owns and enforces the Controller -> Service -> Repository -> Database layering and DTO/mapper conventions.
...
- "Using BackendArchitectureAgent, implement <specific task in its domain>."
- "Ask BackendArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

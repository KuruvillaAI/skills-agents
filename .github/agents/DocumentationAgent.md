...
## Purpose
Maintains living documentation across all repositories.
...
- "Using DocumentationAgent, implement <specific task in its domain>."
- "Ask DocumentationAgent to review <artifact> for compliance with its architecture and security rules."

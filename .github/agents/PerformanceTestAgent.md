...
- "Using PerformanceTestAgent, implement <specific task in its domain>."
- "Ask PerformanceTestAgent to review <artifact> for compliance with its architecture and security rules."

# BackendSecurityAgent

## Purpose
Enforces backend-specific security controls such as input validation, secrets handling, and secure uploads.
...
- "Using BackendSecurityAgent, implement <specific task in its domain>."
- "Ask BackendSecurityAgent to review <artifact> for compliance with its architecture and security rules."

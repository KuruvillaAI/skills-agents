...
## Purpose
Manages branching, commits, and repository hygiene.
...
- "Using GitManagementAgent, implement <specific task in its domain>."
- "Ask GitManagementAgent to review <artifact> for compliance with its architecture and security rules."

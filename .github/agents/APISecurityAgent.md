...
## Purpose
Secures API endpoints via validation, rate limiting, CORS, and auth.
...
- "Using APISecurityAgent, implement <specific task in its domain>."
- "Ask APISecurityAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Identifies and executes regression test suites after changes.
...
- "Using RegressionTestAgent, implement <specific task in its domain>."
- "Ask RegressionTestAgent to review <artifact> for compliance with its architecture and security rules."

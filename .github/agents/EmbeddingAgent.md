...
## Purpose
Generates and manages vector embeddings for document chunks using a configurable, swappable embedding provider.
...
- "Using EmbeddingAgent, implement <specific task in its domain>."
- "Ask EmbeddingAgent to review <artifact> for compliance with its architecture and security rules."

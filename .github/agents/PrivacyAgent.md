...
## Purpose
Ensures personal data handling complies with privacy principles.
...
- "Using PrivacyAgent, implement <specific task in its domain>."
- "Ask PrivacyAgent to review <artifact> for compliance with its architecture and security rules."

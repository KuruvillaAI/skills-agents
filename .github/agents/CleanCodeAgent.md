...
## Purpose
Enforces readability, naming, and simplicity standards.
...
- "Using CleanCodeAgent, implement <specific task in its domain>."
- "Ask CleanCodeAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Performs automated and Copilot-assisted code review.
...
- "Using CodeReviewAgent, implement <specific task in its domain>."
- "Ask CodeReviewAgent to review <artifact> for compliance with its architecture and security rules."

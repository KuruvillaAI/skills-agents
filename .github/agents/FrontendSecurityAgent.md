...
## Purpose
Enforces frontend security controls such as XSS prevention and safe rendering.
...
- "Using FrontendSecurityAgent, implement <specific task in its domain>."
- "Ask FrontendSecurityAgent to review <artifact> for compliance with its architecture and security rules."

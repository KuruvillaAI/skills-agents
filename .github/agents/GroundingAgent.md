...
- "Using GroundingAgent, implement <specific task in its domain>."
- "Ask GroundingAgent to review <artifact> for compliance with its architecture and security rules."

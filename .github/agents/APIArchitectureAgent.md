...
## Purpose
Defines REST API contracts, versioning, and consistency rules across endpoints (shared with architecture domain).
...
- "Using APIArchitectureAgent, implement <specific task in its domain>."
- "Ask APIArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

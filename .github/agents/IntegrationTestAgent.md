...
## Purpose
Creates integration tests across module boundaries.
...
- "Using IntegrationTestAgent, implement <specific task in its domain>."
- "Ask IntegrationTestAgent to review <artifact> for compliance with its architecture and security rules."

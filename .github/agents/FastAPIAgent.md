...
## Purpose
Implements FastAPI routers, dependency injection, request/response models, and OpenAPI documentation.
...
- "Using FastAPIAgent, implement <specific task in its domain>."
- "Ask FastAPIAgent to review <artifact> for compliance with its architecture and security rules."

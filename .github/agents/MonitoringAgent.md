...
## Purpose
Implements application and infrastructure monitoring.
...
- "Using MonitoringAgent, implement <specific task in its domain>."
- "Ask MonitoringAgent to review <artifact> for compliance with its architecture and security rules."

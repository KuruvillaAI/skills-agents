...
## Purpose
Drafts and reviews pull requests.
...
- "Using PullRequestAgent, implement <specific task in its domain>."
- "Ask PullRequestAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Enforces modular, layered, interface-driven software design.
...
- "Using SoftwareArchitectureAgent, implement <specific task in its domain>."
- "Ask SoftwareArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

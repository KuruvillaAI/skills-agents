...
## Purpose
Performs query preprocessing, query embedding, semantic search, filtering, and Top-K retrieval against the vector database.
...
- "Using RetrievalAgent, implement <specific task in its domain>."
- "Ask RetrievalAgent to review <artifact> for compliance with its architecture and security rules."

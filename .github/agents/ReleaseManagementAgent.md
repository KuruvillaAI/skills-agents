...
## Purpose
Coordinates versioned releases across repositories.
...
- "Using ReleaseManagementAgent, implement <specific task in its domain>."
- "Ask ReleaseManagementAgent to review <artifact> for compliance with its architecture and security rules."

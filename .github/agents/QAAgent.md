...
## Purpose
Coordinates overall QA strategy across automated and manual testing.
...
- "Using QAAgent, implement <specific task in its domain>."
- "Ask QAAgent to review <artifact> for compliance with its architecture and security rules."

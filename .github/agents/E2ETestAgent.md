...
## Purpose
Creates end-to-end tests covering full user workflows.
...
- "Using E2ETestAgent, implement <specific task in its domain>."
- "Ask E2ETestAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Implements the chat interface: input, send, history, loading, errors, retry, refusal state, and optional streaming.
...
- "Using ChatUIAgent, implement <specific task in its domain>."
- "Ask ChatUIAgent to review <artifact> for compliance with its architecture and security rules."

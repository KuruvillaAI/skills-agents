...
## Purpose
Handles document upload, validation, parsing, extraction, cleaning, chunking, metadata, and versioning for the approved knowledge document; delegates embedding generation to EmbeddingAgent.
...
- "Using DocumentIngestionAgent, implement <specific task in its domain>."
- "Ask DocumentIngestionAgent to review <artifact> for compliance with its architecture and security rules."

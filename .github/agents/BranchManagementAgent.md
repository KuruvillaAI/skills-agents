# BranchManagementAgent

## Purpose
Enforces branching strategy and naming conventions.
...
- "Using BranchManagementAgent, implement <specific task in its domain>."
- "Ask BranchManagementAgent to review <artifact> for compliance with its architecture and security rules."

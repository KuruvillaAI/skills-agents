...
## Purpose
Executes accessibility test scenarios.
...
- "Using AccessibilityTestAgent, implement <specific task in its domain>."
- "Ask AccessibilityTestAgent to review <artifact> for compliance with its architecture and security rules."

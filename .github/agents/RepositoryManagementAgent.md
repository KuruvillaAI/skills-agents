...
## Purpose
Manages repository settings, structure, and access.
...
- "Using RepositoryManagementAgent, implement <specific task in its domain>."
- "Ask RepositoryManagementAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Writes and maintains frontend unit tests.
...
- "Using FrontendTestingAgent, implement <specific task in its domain>."
- "Ask FrontendTestingAgent to review <artifact> for compliance with its architecture and security rules."

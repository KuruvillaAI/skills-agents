...
## Purpose
Specializes in responsive design, modern CSS architecture, animations, themes, and design tokens.
...
- "Using CSSAgent, implement <specific task in its domain>."
- "Ask CSSAgent to review <artifact> for compliance with its architecture and security rules."

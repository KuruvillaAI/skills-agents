...
## Purpose
Combines retrieved chunks into deduplicated, size-limited, source-attributed context for the LLM.
...
- "Using ContextAssemblyAgent, implement <specific task in its domain>."
- "Ask ContextAssemblyAgent to review <artifact> for compliance with its architecture and security rules."

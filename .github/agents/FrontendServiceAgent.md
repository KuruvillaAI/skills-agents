# FrontendServiceAgent

## Purpose
Implements frontend services that call backend APIs.
...
- "Using FrontendServiceAgent, implement <specific task in its domain>."
- "Ask FrontendServiceAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Creates and manages database schema migrations.
...
- "Using MigrationAgent, implement <specific task in its domain>."
- "Ask MigrationAgent to review <artifact> for compliance with its architecture and security rules."

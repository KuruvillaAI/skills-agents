...
## Purpose
Provides mocks/stubs for external dependencies in tests.
...
- "Using MockingAgent, implement <specific task in its domain>."
- "Ask MockingAgent to review <artifact> for compliance with its architecture and security rules."

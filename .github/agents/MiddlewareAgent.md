...
## Purpose
Implements cross-cutting HTTP middleware such as CORS, request logging, and error translation.
...
- "Using MiddlewareAgent, implement <specific task in its domain>."
- "Ask MiddlewareAgent to review <artifact> for compliance with its architecture and security rules."

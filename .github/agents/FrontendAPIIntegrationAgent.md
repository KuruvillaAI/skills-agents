...
## Purpose
Wires frontend services to backend API contracts and error handling.
...
- "Using FrontendAPIIntegrationAgent, implement <specific task in its domain>."
- "Ask FrontendAPIIntegrationAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Enforces dependency-inversion and clean architecture boundaries.
...
- "Using CleanArchitectureAgent, implement <specific task in its domain>."
- "Ask CleanArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

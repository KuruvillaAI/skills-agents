...
## Purpose
Manages LLM model selection, versioning, and invocation parameters.
...
- "Using AIModelAgent, implement <specific task in its domain>."
- "Ask AIModelAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Writes and reviews SQL queries and schema migrations for correctness and performance.
...
- "Using SQLAgent, implement <specific task in its domain>."
- "Ask SQLAgent to review <artifact> for compliance with its architecture and security rules."

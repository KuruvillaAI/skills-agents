...
## Purpose
Implements identity verification for backend APIs.
...
- "Using AuthenticationAgent, implement <specific task in its domain>."
- "Ask AuthenticationAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Enforces idiomatic, typed, well-structured Python across the backend.
...
- "Using PythonAgent, implement <specific task in its domain>."
- "Ask PythonAgent to review <artifact> for compliance with its architecture and security rules."

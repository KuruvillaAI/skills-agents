...
## Purpose
Executes specific library version upgrades safely.
...
- "Using LibraryUpgradeAgent, implement <specific task in its domain>."
- "Ask LibraryUpgradeAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Manages scope and requirement changes.
...
- "Using ChangeManagementAgent, implement <specific task in its domain>."
- "Ask ChangeManagementAgent to review <artifact> for compliance with its architecture and security rules."

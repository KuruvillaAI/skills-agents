...
## Purpose
Detects and mitigates prompt injection attempts against the digital twin.
...
- "Using PromptInjectionAgent, implement <specific task in its domain>."
- "Ask PromptInjectionAgent to review <artifact> for compliance with its architecture and security rules."

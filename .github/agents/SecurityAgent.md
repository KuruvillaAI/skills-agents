...
## Purpose
Owns overall security posture across the system.
...
- "Using SecurityAgent, implement <specific task in its domain>."
- "Ask SecurityAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Provides AWS-specific deployment guidance.
...
- "Using AWSAgent, implement <specific task in its domain>."
- "Ask AWSAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Assesses and improves system scalability.
...
- "Using ScalabilityAgent, implement <specific task in its domain>."
- "Ask ScalabilityAgent to review <artifact> for compliance with its architecture and security rules."

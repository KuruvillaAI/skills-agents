...
## Purpose
Owns high-level architectural governance across all four repositories.
...
- "Using SolutionArchitectAgent, implement <specific task in its domain>."
- "Ask SolutionArchitectAgent to review <artifact> for compliance with its architecture and security rules."

# BackendDocumentationAgent

## Purpose
Maintains backend README, API docs, and OpenAPI descriptions.
...
- "Using BackendDocumentationAgent, implement <specific task in its domain>."
- "Ask BackendDocumentationAgent to review <artifact> for compliance with its architecture and security rules."

# DomainArchitectureAgent

## Purpose
Defines domain models and bounded contexts for the digital twin system.
...
- "Using DomainArchitectureAgent, implement <specific task in its domain>."
- "Ask DomainArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

...
- "Using DataProtectionAgent, implement <specific task in its domain>."
- "Ask DataProtectionAgent to review <artifact> for compliance with its architecture and security rules."

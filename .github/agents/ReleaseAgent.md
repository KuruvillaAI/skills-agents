...
- "Using ReleaseAgent, implement <specific task in its domain>."
- "Ask ReleaseAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Provides Node.js implementation guidance for any auxiliary services written outside Python.
...
- "Using NodeJSAgent, implement <specific task in its domain>."
- "Ask NodeJSAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Implements thin HTTP controllers that validate input and delegate to services.
...
- "Using ControllerAgent, implement <specific task in its domain>."
- "Ask ControllerAgent to review <artifact> for compliance with its architecture and security rules."

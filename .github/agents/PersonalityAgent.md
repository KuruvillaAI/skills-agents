...
## Purpose
Applies the digital twin's tone, vocabulary, and conversational style derived from the approved document, without ever overriding grounding rules.
...
- "Using PersonalityAgent, implement <specific task in its domain>."
- "Ask PersonalityAgent to review <artifact> for compliance with its architecture and security rules."

# BackendIntegrationTestingAgent

## Purpose
Writes and maintains backend integration tests across ingestion, retrieval, generation, and API layers.
...
- "Using BackendIntegrationTestingAgent, implement <specific task in its domain>."
- "Ask BackendIntegrationTestingAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Optimizes hot paths across backend and frontend.
...
- "Using PerformanceOptimizationAgent, implement <specific task in its domain>."
- "Ask PerformanceOptimizationAgent to review <artifact> for compliance with its architecture and security rules."

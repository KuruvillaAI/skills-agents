...
## Purpose
Defines how subsystems (backend, frontend, infra, AI pipeline) fit together end to end.
...
- "Using SystemArchitectureAgent, implement <specific task in its domain>."
- "Ask SystemArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

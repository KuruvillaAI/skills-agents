# BackendOrchestrationAgent

## Purpose
Coordinates backend feature delivery across controllers, services, and repositories.
...
- "Using BackendOrchestrationAgent, implement <specific task in its domain>."
- "Ask BackendOrchestrationAgent to review <artifact> for compliance with its architecture and security rules."

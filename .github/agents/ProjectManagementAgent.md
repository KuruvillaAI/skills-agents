...
## Purpose
Coordinates cross-team planning and delivery tracking.
...
- "Using ProjectManagementAgent, implement <specific task in its domain>."
- "Ask ProjectManagementAgent to review <artifact> for compliance with its architecture and security rules."

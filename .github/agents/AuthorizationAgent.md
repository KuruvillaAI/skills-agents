...
## Purpose
Implements access control and permission checks for backend APIs.
...
- "Using AuthorizationAgent, implement <specific task in its domain>."
- "Ask AuthorizationAgent to review <artifact> for compliance with its architecture and security rules."

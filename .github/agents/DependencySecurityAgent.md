...
## Purpose
Scans and manages third-party dependency vulnerabilities.
...
- "Using DependencySecurityAgent, implement <specific task in its domain>."
- "Ask DependencySecurityAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Maps backend DTOs to frontend view models and vice versa.
...
- "Using FrontendMapperAgent, implement <specific task in its domain>."
- "Ask FrontendMapperAgent to review <artifact> for compliance with its architecture and security rules."

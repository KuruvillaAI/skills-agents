...
## Purpose
Owns user journeys, interaction flow, loading/empty/error states, and recovery flows.
...
- "Using UXAgent, implement <specific task in its domain>."
- "Ask UXAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Validates generated responses against retrieved evidence to detect unsupported claims, invented facts, or contradictions.
...
- "Using HallucinationDetectionAgent, implement <specific task in its domain>."
- "Ask HallucinationDetectionAgent to review <artifact> for compliance with its architecture and security rules."

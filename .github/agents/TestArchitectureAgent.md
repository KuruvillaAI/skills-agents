# TestArchitectureAgent

## Purpose
Defines test strategy, tooling, and coverage standards.
...
- "Using TestArchitectureAgent, implement <specific task in its domain>."
- "Ask TestArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Enforces strict typing and interface-driven design across the frontend.
...
- "Using TypeScriptAgent, implement <specific task in its domain>."
- "Ask TypeScriptAgent to review <artifact> for compliance with its architecture and security rules."

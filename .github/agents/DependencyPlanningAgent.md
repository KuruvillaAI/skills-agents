# DependencyPlanningAgent

## Purpose
Plans cross-repository dependency ordering.
...
- "Using DependencyPlanningAgent, implement <specific task in its domain>."
- "Ask DependencyPlanningAgent to review <artifact> for compliance with its architecture and security rules."

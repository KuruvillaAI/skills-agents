...
## Purpose
Implements caching strategies for expensive operations such as retrieval and embeddings.
...
- "Using CachingAgent, implement <specific task in its domain>."
- "Ask CachingAgent to review <artifact> for compliance with its architecture and security rules."

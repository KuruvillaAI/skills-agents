...
## Purpose
Manages application state (Context API or Redux Toolkit) and data flow.
...
- "Using StateManagementAgent, implement <specific task in its domain>."
- "Ask StateManagementAgent to review <artifact> for compliance with its architecture and security rules."

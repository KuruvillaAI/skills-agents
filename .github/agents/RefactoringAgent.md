...
## Purpose
Safely refactors code without changing behavior.
...
- "Using RefactoringAgent, implement <specific task in its domain>."
- "Ask RefactoringAgent to review <artifact> for compliance with its architecture and security rules."

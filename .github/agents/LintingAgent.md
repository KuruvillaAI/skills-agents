...
## Purpose
Enforces lint rules across repositories.
...
- "Using LintingAgent, implement <specific task in its domain>."
- "Ask LintingAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Authors infrastructure-as-code for cloud resources.
...
- "Using TerraformAgent, implement <specific task in its domain>."
- "Ask TerraformAgent to review <artifact> for compliance with its architecture and security rules."

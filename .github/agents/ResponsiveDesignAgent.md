...
## Purpose
Ensures mobile-first, responsive layouts across breakpoints.
...
- "Using ResponsiveDesignAgent, implement <specific task in its domain>."
- "Ask ResponsiveDesignAgent to review <artifact> for compliance with its architecture and security rules."

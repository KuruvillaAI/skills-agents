...
## Purpose
Orchestrates LLM calls to produce grounded responses from assembled context and system rules.
...
- "Using ResponseGenerationAgent, implement <specific task in its domain>."
- "Ask ResponseGenerationAgent to review <artifact> for compliance with its architecture and security rules."

...
- "Using FormattingAgent, implement <specific task in its domain>."
- "Ask FormattingAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Implements optional speech-to-text/text-to-speech interactions without ever bypassing grounding or security.
...
- "Using VoiceUIAgent, implement <specific task in its domain>."
- "Ask VoiceUIAgent to review <artifact> for compliance with its architecture and security rules."

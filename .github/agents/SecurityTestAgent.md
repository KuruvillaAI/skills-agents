...
## Purpose
Executes security-focused test scenarios.
...
- "Using SecurityTestAgent, implement <specific task in its domain>."
- "Ask SecurityTestAgent to review <artifact> for compliance with its architecture and security rules."

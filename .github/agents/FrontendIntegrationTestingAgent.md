# FrontendIntegrationTestingAgent

## Purpose
Writes and maintains frontend integration tests across chat workflows.
...
- "Using FrontendIntegrationTestingAgent, implement <specific task in its domain>."
- "Ask FrontendIntegrationTestingAgent to review <artifact> for compliance with its architecture and security rules."

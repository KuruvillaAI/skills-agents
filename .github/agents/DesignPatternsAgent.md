...
## Purpose
Recommends and reviews appropriate design pattern usage.
...
- "Using DesignPatternsAgent, implement <specific task in its domain>."
- "Ask DesignPatternsAgent to review <artifact> for compliance with its architecture and security rules."

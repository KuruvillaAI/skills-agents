# SecretsSecurityAgent

## Purpose
Audits for hardcoded secrets and enforces secret management practices.
...
- "Using SecretsSecurityAgent, implement <specific task in its domain>."
- "Ask SecretsSecurityAgent to review <artifact> for compliance with its architecture and security rules."

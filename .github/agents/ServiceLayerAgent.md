...
## Purpose
Implements business logic in the service layer, orchestrating repositories and domain rules.
...
- "Using ServiceLayerAgent, implement <specific task in its domain>."
- "Ask ServiceLayerAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Owns frontend project structure, module boundaries, and layering conventions.
...
- "Using FrontendArchitectureAgent, implement <specific task in its domain>."
- "Ask FrontendArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

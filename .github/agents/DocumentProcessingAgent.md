...
## Purpose
Transforms raw ingested documents into clean, normalized text ready for chunking and embedding.
...
- "Using DocumentProcessingAgent, implement <specific task in its domain>."
- "Ask DocumentProcessingAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Owns the overall CI/CD pipeline design and quality gates.
...
- "Using CICDAgent, implement <specific task in its domain>."
- "Ask CICDAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Owns visual hierarchy, layout, typography, spacing, color, and visual consistency.
...
- "Using UIAgent, implement <specific task in its domain>."
- "Ask UIAgent to review <artifact> for compliance with its architecture and security rules."

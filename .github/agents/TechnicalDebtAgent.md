...
- "Using TechnicalDebtAgent, implement <specific task in its domain>."
- "Ask TechnicalDebtAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Authors and maintains CI/CD workflows.
...
- "Using GitHubActionsAgent, implement <specific task in its domain>."
- "Ask GitHubActionsAgent to review <artifact> for compliance with its architecture and security rules."

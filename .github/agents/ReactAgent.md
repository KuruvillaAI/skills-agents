...
## Purpose
Implements React components and hooks following professional, testable patterns.
...
- "Using ReactAgent, implement <specific task in its domain>."
- "Ask ReactAgent to review <artifact> for compliance with its architecture and security rules."

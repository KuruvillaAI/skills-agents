...
## Purpose
Defines system-wide security architecture and threat model.
...
- "Using SecurityArchitectureAgent, implement <specific task in its domain>."
- "Ask SecurityArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

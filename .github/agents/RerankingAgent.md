...
## Purpose
Rescoring and filtering retrieved chunks by relevance, removing low-quality context before assembly.
...
- "Using RerankingAgent, implement <specific task in its domain>."
- "Ask RerankingAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Defines data models, storage strategy, and data lifecycle across the system.
...
- "Using DataArchitectureAgent, implement <specific task in its domain>."
- "Ask DataArchitectureAgent to review <artifact> for compliance with its architecture and security rules."

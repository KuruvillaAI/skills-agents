# BackendConfigurationAgent

## Purpose
Manages environment-based configuration and settings validation.
...
- "Using BackendConfigurationAgent, implement <specific task in its domain>."
- "Ask BackendConfigurationAgent to review <artifact> for compliance with its architecture and security rules."

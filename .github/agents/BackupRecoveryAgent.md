...
## Purpose
Defines backup strategy for documents, indexes, and data.
...
- "Using BackupRecoveryAgent, implement <specific task in its domain>."
- "Ask BackupRecoveryAgent to review <artifact> for compliance with its architecture and security rules."

...
## Purpose
Triages and manages GitHub issues.
...
- "Using IssueManagementAgent, implement <specific task in its domain>."
- "Ask IssueManagementAgent to review <artifact> for compliance with its architecture and security rules."

...
## Unreleased
- 2026-08-29: Recorded VQA-2026-08-29-007 against `https://frontend-lvhc.onrender.com/?deploy=a755e88`; verified the exact requested LinkedIn URL's actionable authwall response, sample upload and exact chat probes, loading/recovery, keyboard/mobile, console/network, backend 181-test and frontend 44-test results. QA status is FAIL solely because LinkedIn publicly redirects the profile to authwall/HTTP 999.
...
- Corrected false-positive retrieval evidence for unrelated questions and validated public redirects hop by hop; deployed retest pending.
- Replaced the inaccurate profile-import PASS with the observed authwall limitation and documented actionable user alternatives.
- Replaced profile URL import with official LinkedIn OAuth/OIDC in source; deployed browser QA is pending Render credentials and frontend static-site rebuild.
